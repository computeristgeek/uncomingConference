<?php
	$keywords='icntse,pua,kth,international conference,new trends,sustainable energy,science,extended abstract,keynote,speakers';
	$description='This page lists the ICNTSE Conference Keynotes.';
	$title='Documents - ICNTSE';
?>
	...
	<div class="container">
	    ...
	    <div class="row">
	    	...
	    	<div class="col-md-6">
	    		...
	    		<h2 class="text-center">List of Papers</h2>
	    		<div class="text-center">
	    			<a class="btn btn-primary" href="PapersList_Day01.pdf">Day 1</a>
	    			<a class="btn btn-primary" href="PapersList_Day02.pdf">Day 2</a>
	    			<a class="btn btn-primary" href="PapersList_Day03.pdf">Day 3</a>
	    		</div>
	    	</div>
	    </div>
	</div>
